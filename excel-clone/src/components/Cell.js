...
//Cells hold elements with object data (strings/numbers)
//Logic handles inputting data into cells/clicking behavior
...
export default class Cell extends React.Component {
  ...
  calculateCss = () => {
    const css = {
      ...
      lineHeight: '15px',
      overflow: 'hidden',
      fontFamily: 'Calibri, Thonburi, Arial, Verdana, sans-serif',
    }
